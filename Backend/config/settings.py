...
SECRET_KEY = 'django-insecure-hrc8)m4v=rm_*yi8^rh$!xm&yr!8)ux%b-u8p@7@wx3a#ie6*#'
...
SIMPLE_JWT = {
    ...
    "ACCESS_TOKEN_LIFETIME": timedelta(days=30), # TODO # set to short
    "REFRESH_TOKEN_LIFETIME": timedelta(days=30), # TODO # set to long
}
